$_L(["java.io.OutputStream"],"java.io.ByteArrayOutputStream",["java.lang.IllegalArgumentException","$.IndexOutOfBoundsException","$.NullPointerException","org.apache.harmony.luni.util.Msg"],function(){
c$=$_C(function(){
this.buf=null;
this.count=0;
$_Z(this,arguments);
...
throw new IndexOutOfBoundsException(org.apache.harmony.luni.util.Msg.getString("K002f"));
}}else{
