...
Clazz.load (["org.jmol.adapter.readers.quantum.SpartanInputReader"], "org.jmol.adapter.readers.quantum.SpartanSmolReader", ["java.lang.Boolean", "$.Double", "java.util.Hashtable", "org.jmol.adapter.readers.quantum.SpartanArchive", "org.jmol.util.Logger", "$.Parser", "$.StringXBuilder"], function () {
...
if ((pt = this.line.indexOf (")")) > 0) this.titles.put ("Title" + this.parseIntStr (this.line.substring (0, pt)), (this.line.substring (pt + 1).trim ()));
}
