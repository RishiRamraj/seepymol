...
value = org.jmol.io.JmolBinary.getInputStreamReader (value);
} catch (e) {
...
($fz = function (dz) {
if (this.thisMesh == null) return;
var navPt = org.jmol.util.Point3f.newP (this.viewer.getNavigationOffset ());
var toPt =  new org.jmol.util.Point3f ();
...
var pt2 = org.jmol.util.Point3f.newP (ptRet);
pt2.add (vNorm);
...
var toPts =  new org.jmol.util.Point3f ();
var toPt = org.jmol.util.Point3f.newP (vNorm);
toPt.add (pt);
...
navPt = org.jmol.util.Point3f.newP (this.viewer.getNavigationOffset ());
if (nSeconds <= 0) return;
this.viewer.saveOrientation ("_navsurf");
o1.restore (0, true);
this.viewer.script ("restore orientation _navsurf " + nSeconds);
}, $fz.isPrivate = true, $fz), "org.jmol.util.Point3f,org.jmol.util.Vector3f,~N");
...
if ((d = centers[i].distance (toPt)) >= dmin) continue;
dmin = d;
imin = i;
}
...
return true;
}, $fz.isPrivate = true, $fz), "org.jmol.shapesurface.IsosurfaceMesh,org.jmol.util.Point3f,org.jmol.util.Point3f,org.jmol.util.Vector3f");
...
}, $fz.isPrivate = true, $fz), "org.jmol.shapesurface.IsosurfaceMesh,~N,org.jmol.util.Point3f,org.jmol.util.Point3f,org.jmol.util.Vector3f");
