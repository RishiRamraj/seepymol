...
var zis = this.newZipInputStream (is);
var ze;
...
var len;
while (is.available () >= 1 && (len = is.read (buf, 0, 1024)) > 0) sb.append ( String.instantialize (buf, 0, len));
...
sData =  String.instantialize (bytes);
...
org.jmol.io.JmolBinary.getJzu ().getAllZipData (is, [], "", "Molecule", fileData);
var prefix = "|";
