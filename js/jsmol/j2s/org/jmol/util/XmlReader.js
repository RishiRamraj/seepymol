...
Clazz.load (null, "org.jmol.util.XmlReader", ["java.lang.Character", "org.jmol.util.Escape", "$.Point3f", "$.StringXBuilder", "$.XmlUtil"], function () {
...
ipt += what.length;
next[0] = ipt + offset;
if (offset > 0 && ipt < data.length && data.charAt (ipt) != '=') return org.jmol.util.XmlReader.setNext (data, what, next, offset);
return next[0];
