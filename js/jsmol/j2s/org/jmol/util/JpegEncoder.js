...
Clazz.load (null, ["org.jmol.util.JpegEncoder", "$.JpegInfo", "$.Huffman", "$.DCT"], ["java.io.BufferedOutputStream", "$.ByteArrayOutputStream", "org.jmol.util.Logger"], function () {
...
this.JpegObj =  new org.jmol.util.JpegInfo (apiPlatform, image, comment);
this.outStream =  new java.io.BufferedOutputStream (out);
this.dct =  new org.jmol.util.DCT (this.Quality);
this.Huf =  new org.jmol.util.Huffman (this.JpegObj.imageWidth, this.JpegObj.imageHeight);
...
org.jmol.util.JpegEncoder.write (apiPlatform, image, quality, os, comment);
try {
os.flush ();
os.close ();
} catch (e) {
...
( new org.jmol.util.JpegEncoder (apiPlatform, image, quality, os, comment)).Compress ();
}, "org.jmol.api.ApiPlatform,~O,~N,java.io.OutputStream,~S");
Clazz.defineMethod (c$, "setQuality", 
function (quality) {
this.dct =  new org.jmol.util.DCT (quality);
}, "~N");
Clazz.defineMethod (c$, "Compress", 
function () {
if (this.JpegObj == null) return;
var longState = org.jmol.util.JpegEncoder.WriteHeaders (this.outStream, this.JpegObj, this.dct);
org.jmol.util.JpegEncoder.WriteCompressedData (this.outStream, this.JpegObj, this.dct, this.Huf);
org.jmol.util.JpegEncoder.WriteEOI (this.outStream);
...
dctArray2 = org.jmol.util.DCT.forwardDCT (dctArray1);
dctArray3 = org.jmol.util.DCT.quantizeBlock (dctArray2, dct.divisors[QNumber]);
...
}, $fz.isPrivate = true, $fz), "java.io.BufferedOutputStream,org.jmol.util.JpegInfo,org.jmol.util.DCT,org.jmol.util.Huffman");
c$.WriteEOI = Clazz.defineMethod (c$, "WriteEOI", 
($fz = function (out) {
var EOI = [0xFF, 0xD9];
org.jmol.util.JpegEncoder.WriteMarker (EOI, out);
...
var tempArray;
var SOI = [0xFF, 0xD8];
org.jmol.util.JpegEncoder.WriteMarker (SOI, out);
...
JFIF[16] = 0x00;
JFIF[17] = 0x00;
org.jmol.util.JpegEncoder.writeArray (JFIF, out);
var comment = null;
if (JpegObj.Comment.length > 0) org.jmol.util.JpegEncoder.writeString (JpegObj.Comment, 0xE1, out);
org.jmol.util.JpegEncoder.writeString ("JPEG Encoder Copyright 1998, James R. Weeks and BioElectroMech.\n\n", 0xFE, out);
...
for (j = 0; j < 64; j++) {
DQT[offset++] = tempArray[org.jmol.util.Huffman.jpegNaturalOrder[j]];
}
}
org.jmol.util.JpegEncoder.writeArray (DQT, out);
...
org.jmol.util.JpegEncoder.writeArray (SOF, out);
org.jmol.util.JpegEncoder.WriteDHTHeader (org.jmol.util.Huffman.bitsDCluminance, org.jmol.util.Huffman.valDCluminance, out);
org.jmol.util.JpegEncoder.WriteDHTHeader (org.jmol.util.Huffman.bitsACluminance, org.jmol.util.Huffman.valACluminance, out);
org.jmol.util.JpegEncoder.WriteDHTHeader (org.jmol.util.Huffman.bitsDCchrominance, org.jmol.util.Huffman.valDCchrominance, out);
org.jmol.util.JpegEncoder.WriteDHTHeader (org.jmol.util.Huffman.bitsACchrominance, org.jmol.util.Huffman.valACchrominance, out);
...
org.jmol.util.JpegEncoder.writeArray (SOS, out);
return comment;
}, $fz.isPrivate = true, $fz), "java.io.BufferedOutputStream,org.jmol.util.JpegInfo,org.jmol.util.DCT");
...
org.jmol.util.JpegEncoder.writeTag (nBytes + suffix.length, id, out);
org.jmol.util.JpegEncoder.writeArray (s.substring (i0, i0 + nBytes).getBytes (), out);
if (suffix.length > 0) org.jmol.util.JpegEncoder.writeArray (suffix.getBytes (), out);
i0 += nBytes;
}
...
COM[2] = ((length >> 8) & 0xFF);
COM[3] = (length & 0xFF);
org.jmol.util.JpegEncoder.writeArray (COM, out);
...
DHT4[3] = ((index - 2) & 0xFF);
org.jmol.util.JpegEncoder.writeArray (DHT4, out);
...
org.jmol.util.DCT.AANscale (this.DivisorsLuminance, this.quantum_luminance, quality);
...
org.jmol.util.DCT.AANscale (this.DivisorsChrominance, this.quantum_chrominance, quality);
...
for (var i = 0, index = 0; i < 8; i++) for (var j = 0; j < 8; j++, index++) divisors[index] = (0.125 / (values[index] * org.jmol.util.DCT.AANscaleFactor[i] * org.jmol.util.DCT.AANscaleFactor[j]));
...
for (k = 1; k < 64; k++) {
if ((temp = zigzag[org.jmol.util.Huffman.jpegNaturalOrder[k]]) == 0) {
r++;
} else {
while (r > 15) {
...
p = 0;
for (l = 1; l <= 16; l++) {
for (i = org.jmol.util.Huffman.bitsDCchrominance[l]; --i >= 0; ) {
huffsize[p++] = l;
}
}
huffsize[p] = 0;
...
for (p = 0; p < lastp; p++) {
this.DC_matrix1[org.jmol.util.Huffman.valDCchrominance[p]][0] = huffcode[p];
this.DC_matrix1[org.jmol.util.Huffman.valDCchrominance[p]][1] = huffsize[p];
}
p = 0;
for (l = 1; l <= 16; l++) {
for (i = org.jmol.util.Huffman.bitsACchrominance[l]; --i >= 0; ) {
huffsize[p++] = l;
}
}
huffsize[p] = 0;
...
for (p = 0; p < lastp; p++) {
this.AC_matrix1[org.jmol.util.Huffman.valACchrominance[p]][0] = huffcode[p];
this.AC_matrix1[org.jmol.util.Huffman.valACchrominance[p]][1] = huffsize[p];
}
p = 0;
for (l = 1; l <= 16; l++) {
for (i = org.jmol.util.Huffman.bitsDCluminance[l]; --i >= 0; ) {
huffsize[p++] = l;
}
}
huffsize[p] = 0;
...
for (p = 0; p < lastp; p++) {
this.DC_matrix0[org.jmol.util.Huffman.valDCluminance[p]][0] = huffcode[p];
this.DC_matrix0[org.jmol.util.Huffman.valDCluminance[p]][1] = huffsize[p];
}
p = 0;
for (l = 1; l <= 16; l++) {
for (i = org.jmol.util.Huffman.bitsACluminance[l]; --i >= 0; ) {
huffsize[p++] = l;
}
}
huffsize[p] = 0;
...
this.AC_matrix0[org.jmol.util.Huffman.valACluminance[q]][0] = huffcode[q];
this.AC_matrix0[org.jmol.util.Huffman.valACluminance[q]][1] = huffsize[q];
}
...
var values =  Clazz.newIntArray (this.imageWidth * this.imageHeight, 0);
var r;
var g;
var b;
var y;
...
values = apiPlatform.grabPixels (this.imageobj, this.imageWidth, this.imageHeight);
