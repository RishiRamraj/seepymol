...
Clazz.load (["org.jmol.minimize.forcefield.ForceField", "org.jmol.script.Token"], "org.jmol.minimize.forcefield.ForceFieldUFF", ["java.lang.NullPointerException", "java.util.ArrayList", "$.Hashtable", "org.jmol.minimize.forcefield.CalculationsUFF", "$.FFParam", "org.jmol.util.Elements", "$.Logger", "$.Parser"], function () {
...
}br = org.jmol.minimize.forcefield.ForceField.getResource (url);
var line;
...
System.err.println ("Couldn't find file: " + fileName);
throw  new NullPointerException ();
}var br = org.jmol.minimize.forcefield.ForceField.getResource (url);
var line;
while ((line = br.readLine ()) != null) {
