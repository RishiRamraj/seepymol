...
Clazz.load (["org.jmol.minimize.forcefield.ForceField"], "org.jmol.minimize.forcefield.ForceFieldMMFF", ["java.lang.Boolean", "$.Double", "$.Float", "$.NullPointerException", "java.util.ArrayList", "$.Hashtable", "org.jmol.minimize.MinAtom", "$.MinObject", "org.jmol.minimize.forcefield.AtomType", "$.CalculationsMMFF", "org.jmol.util.ArrayUtil", "$.BitSet", "$.BitSetUtil", "$.Elements", "$.Escape", "$.Logger"], function () {
...
System.err.println ("Exception " + e.getMessage () + " in getResource " + fileName + " line=" + line);
} else {
throw e;
}
}
...
}return org.jmol.minimize.forcefield.ForceField.getResource (url);
}, $fz.isPrivate = true, $fz), "~S");
